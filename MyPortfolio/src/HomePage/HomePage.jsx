...
export default function HomePage() {
  return (
    <div className="main">
      ...
      <h1 className="main-left-text">hello</h1>

      </div>

      <div className="main-right">
      <h1 className="main-text">
      Hi, I’m Nikita, a passionate programmer with a love for solving complex problems and creating intuitive, efficient solutions. With experience in: <h1  className="GradientText"> Html, Css, Js, React, Bootstrap, Tailwind.css</h1> and a focus on Web Development, I build projects that blend creativity and functionality.
      ...
      <img src={ProgrammerImage} alt=""  style={{width:'600px', height:'560px', marginTop:'50px', borderRadius:'10px'}}/>
      </div>
    </div>
  );
}
